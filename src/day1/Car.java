...
public class Car {
	 ...
	 * 		수행문;
	 * 
	 * 		return 값;	// 반환타입이 void 인 경우에는 필요없다.
	 * }
	 * 
	 ...
	 * 			   반환타입이 이 메소드를 호출하는 측에게 이 메소드 실행 결과로
	 * 			   획득되는 값의 타입을 알려줌으로써 반환값을 저장할 수 있는 변수의 타입을
	 * 			   결정할 수 있게 한다.
